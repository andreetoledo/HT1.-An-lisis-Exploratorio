...
#ggplot(sum_movies,aes(genres))+
 # geom_bar()+
  #scale_x_binned()
#pie(genres, main = "Grafia de pie de los géneros")
```
...
#text(paste("Correlación entre presupuestos e ingresos:", round(cor(sum_movies$budget,sum_movies$revenue),2)))
```
